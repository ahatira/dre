...
### `icons-registry.json`
Complete auto-generated registry of all available icons (141 items). Generated by `npm run build:icons`.
...
**Structure:**
- `generated`: Timestamp of last build
- `total`: Total number of icons (141)
- `names`: Array of all icon names (sorted alphabetically)
