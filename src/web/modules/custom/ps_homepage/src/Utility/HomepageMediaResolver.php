...
/**
 * Resolves media entity references for homepage block image fields.
 */
final class HomepageMediaResolver {
  ...
  /**
   * Resolves a stored media ID to URL, alt text and credit.
   */
  public function resolve(mixed $reference, ?string $langcode = NULL): HomepageMediaReference {
    $mid = (int) $reference;
    if ($mid <= 0) {
      return HomepageMediaReference::empty();
    }
    ...
    return new HomepageMediaReference($url, $alt, $credit, $cacheTags);
  }
