...
#[ConfigEntityType(
  ...
  links: [
    'collection' => '/admin/ps/content/promo-card/placements',
    'add-form' => '/admin/ps/content/promo-card/placements/add',
    'edit-form' => '/admin/ps/content/promo-card/placements/{promo_card_placement}',
    'delete-form' => '/admin/ps/content/promo-card/placements/{promo_card_placement}/delete',
  ],
)]
