...
final class FilterBarHtmxSettings {
  ...
  /**
   * Route path for live count label fragments.
   */
  public const COUNT_LABEL_ROUTE = '/ps-search-filters/htmx/count-label';

  /**
   * Route path for Property type popin apply (HTMX trigger).
   */
  public const APPLY_TYPE_ROUTE = '/ps-search-filters/htmx/apply-type';

  /**
   * Route path for Location popin apply (HTMX trigger).
   */
  public const APPLY_LOCATION_ROUTE = '/ps-search-filters/htmx/apply-location';

  /**
   * Route path for Surface popin apply (HTMX trigger).
   */
  public const APPLY_SURFACE_ROUTE = '/ps-search-filters/htmx/apply-range/surface';

  /**
   * Route path for Capacity popin apply (HTMX trigger).
   */
  public const APPLY_CAPACITY_ROUTE = '/ps-search-filters/htmx/apply-range/capacity';

  /**
   * Route path for Budget popin apply (HTMX trigger).
   */
  public const APPLY_BUDGET_ROUTE = '/ps-search-filters/htmx/apply-range/budget';

  /**
   * Route path prefix for lazy-loaded More criteria groups (HTMX fragment).
   */
  public const MORE_CRITERIA_ROUTE = '/ps-search-filters/htmx/more-criteria';

  /**
   * Route path for mobile filters offcanvas apply (HTMX trigger).
   */
  public const APPLY_MOBILE_ROUTE = '/ps-search-filters/htmx/apply-mobile';

  /**
   * Route path for the search results pane header fragment.
   */
  public const RESULTS_HEADER_ROUTE = '/ps-search-filters/htmx/results-header';
