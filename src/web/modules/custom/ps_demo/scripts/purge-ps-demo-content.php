...
/**
 * @file
 * Purges entities exported in ps_demo/export/content/ (for import testing).
 *
 * Usage: drush php:script web/modules/custom/ps_demo/scripts/purge-ps-demo-content.php
 */
...
$module_path = DRUPAL_ROOT . '/' . \Drupal::service('extension.list.module')->getPath('ps_demo') . '/export/content';
