...
assert_html_not_contains 'data-ps-compare-table-head-pin' "Comparison table uses single scrollable table"
assert_html_not_contains 'ps-compare-table--head' "Pinned head table removed"
assert_html_contains 'data-ps-compare-table' "Comparison table markup present"
...
assert_html_contains 'ps-compare-table__row--photos' "Photos row with property cards"
assert_html_contains 'ps-compare-table__column-header' "Property card in Photos row"
assert_html_contains 'ps-compare-table__column-media' "Gallery inside Photos property card"
...
assert_html_contains 'ps-compare-button--compare-table' "Compare remove button uses compare-table variant in column header"
assert_html_contains 'data-ps-compare-remove-confirm' "Compare remove button requires confirmation in column header"
