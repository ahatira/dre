...
assert_html_contains 'data-ps-compare-modal-footer' "Compare modal footer placeholder present"
assert_html_contains 'data-ps-compare-share-modal' "Share modal shell on search page"
assert_html_contains 'shareModalEndpoint' "shareModalEndpoint present in drupalSettings"
assert_html_contains '\/api\/compare\/share-modal' "shareModalEndpoint uses /api/compare/share-modal"
...
assert_http_403 "$BASE/api/compare/share-modal" "GET /api/compare/share-modal without enough items"
