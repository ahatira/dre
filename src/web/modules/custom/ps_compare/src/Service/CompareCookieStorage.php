 ...
 *
 */
final class CompareCookieStorage {

  public const COOKIE_NAME = 'ps_compare';
  ...
  /**
   * @return int[]
   *   Compared entity IDs from the signed cookie (FIFO order).
   */
   ...
   *
   * @return array<string, int[]>
   *   Normalized items preserving order.
   */
  private function normalizeItems(array $items): array {
    ...
    foreach ($items as $entityTypeId => $entityIds) {
      ...
      if ($ordered !== []) {
        $normalized[$entityTypeId] = $ordered;
      }
    }
