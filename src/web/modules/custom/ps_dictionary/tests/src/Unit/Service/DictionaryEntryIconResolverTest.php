...
final class DictionaryEntryIconResolverTest extends UnitTestCase {
  ...
  public function testGetDefaultIconIdForAssetType(): void {
    ...
    $this->assertSame('bnp_custom:logistic-warehouses', $resolver->getDefaultIconId('asset_type', 'ENT'));
  ...
  public function testResolvePartsUsesContextWhenEntryMissing(): void {
    ...
    $entParts = $resolver->resolveParts(NULL, [
      'type' => 'asset_type',
      'code' => 'ENT',
    ]);
    $this->assertSame('bnp_custom:logistic-warehouses', $entParts['full_id']);
  }
