...
class UiSkins {
   ...
   */
  public const string PAGE_TOP_CSS_VARIABLES_KEY = 'ui_suite_bnp_form_required';
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $ui_skins_css_variables_settings = $this->themeSettings->getSetting(UiSkinsInterface::CSS_VARIABLES_THEME_SETTING_KEY);
    ...
    $inline_css = '';
    // Required mark.
    if (isset($ui_skins_css_variables_settings['bs_danger'][':root']) && \is_string($ui_skins_css_variables_settings['bs_danger'][':root'])) {
    ...
    if (isset($ui_skins_css_variables_settings['bs_white'][':root']) && \is_string($ui_skins_css_variables_settings['bs_white'][':root'])) {
