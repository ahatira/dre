...
class Element extends DrupalAttributes {
   ...
   *
   * @return \Drupal\ui_suite_bnp\Utility\Element
   *   The child element object.
   */
  public function &__get($key) {
    if (CoreElement::property($key)) {
      throw new \InvalidArgumentException('Cannot dynamically retrieve element property. Use \Drupal\ui_suite_bnp\Utility\Element::getProperty instead.');
    }
  ...
  public function __set($key, $value) {
    if (CoreElement::property($key)) {
      throw new \InvalidArgumentException('Cannot dynamically retrieve element property. Use  \Drupal\ui_suite_bnp\Utility\Element::setProperty instead.');
    }
  ...
  public function __isset($name) {
    if (CoreElement::property($name)) {
      throw new \InvalidArgumentException('Cannot dynamically check if an element has a property. Use  \Drupal\ui_suite_bnp\Utility\Element::unsetProperty instead.');
    }
  ...
  public function __unset($name) {
    if (CoreElement::property($name)) {
      throw new \InvalidArgumentException('Cannot dynamically unset an element property. Use  \Drupal\ui_suite_bnp\Utility\Element::hasProperty instead.');
    }
    parent::__unset($name);
  }
  ...
  /**
   * Creates a new \Drupal\ui_suite_bnp\Utility\Element instance.
   *
   * @param array|string|\Drupal\ui_suite_bnp\Utility\Element $element
   ...
   *
   * @return \Drupal\ui_suite_bnp\Utility\Element|false
