...
class Attributes extends ArrayObject {
   ...
   *
   * @see \Drupal\ui_suite_bnp\Utility\ArrayObject::offsetGet()
   */
   ...
   *   TRUE or FALSE.
   *
   * @see \Drupal\ui_suite_bnp\Utility\ArrayObject::offsetExists()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnp\Utility\ArrayObject::offsetUnset()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnp\Utility\ArrayObject::offsetSet()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnp\Utility\ArrayObject::merge()
   */
