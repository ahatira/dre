...
namespace Drupal\ui_suite_bnp\Utility;
...
class DrupalAttributes extends ArrayObject {
   ...
   * @var string
   */
  public const string DESCRIPTION = 'description_attributes';
   ...
   * @var string
   */
  public const string FIELDSET_WRAPPER = 'fieldset_wrapper_attributes';
   ...
   * @var string
   */
  public const string INNER_WRAPPER = 'inner_wrapper_attributes';
   ...
   * @var string
   */
  public const string INPUT_GROUP = 'input_group_attributes';
   ...
   * @var string
   */
  public const string LABEL = 'label_attributes';
   ...
   * @var string
   */
  public const string TITLE = 'title_attributes';
   ...
   * @var string
   */
  public const string WRAPPER = 'wrapper_attributes';

  /**
   * Stored attribute instances.
   *
   * @var \Drupal\ui_suite_bnp\Utility\Attributes[]
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::addClass()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::getAttribute()
   */
   ...
   *   (optional) The type of attributes to use for this method.
   *
   * @return \Drupal\ui_suite_bnp\Utility\Attributes
   ...
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::getClasses()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::hasAttribute()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::hasClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::removeAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::removeClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::replaceClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::setAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnp\Utility\Attributes::setAttributes()
   */
