import { t as E, T as S } from './iframe-D21U4yYN.js';
import { a as _, D as W } from './twig-BPJOkNgt.js';
_(S);
S.cache(!1);
const y = (t) => t,
  e = (t = {}) => {
    const n = E.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/elements/eyebrow/eyebrow.twig',
      data: [
        {
          type: 'raw',
          value: `
...
`,
        ...
        },
        {
          ...
          token: {
            ...
            key: 'uppercase',
            expression: [
              { type: 'Twig.expression.type.variable', value: 'uppercase', match: ['uppercase'] },
              {
                type: 'Twig.expression.type.filter',
                value: 'default',
                match: ['|default', 'default'],
        ...
        },
        {
          ...
          token: {
            ...
            key: 'bold',
            expression: [
              { type: 'Twig.expression.type.variable', value: 'bold', match: ['bold'] },
              {
                type: 'Twig.expression.type.filter',
                value: 'default',
                match: ['|default', 'default'],
        ...
        },
        {
          ...
          token: {
            ...
            key: 'withLine',
            expression: [
              { type: 'Twig.expression.type.variable', value: 'withLine', match: ['withLine'] },
              {
                type: 'Twig.expression.type.filter',
                value: 'default',
                match: ['|default', 'default'],
        ...
        },
        {
          ...
          token: {
            ...
            key: 'withDot',
            expression: [
              { type: 'Twig.expression.type.variable', value: 'withDot', match: ['withDot'] },
              {
                type: 'Twig.expression.type.filter',
                value: 'default',
                match: ['|default', 'default'],
...
`,
        ...
        },
        {
          ...
          token: {
            ...
            expression: [
              ...
              { type: 'Twig.expression.type.string', value: 'ps-eyebrow' },
              ...
              { type: 'Twig.expression.type.comma' },
              { type: 'Twig.expression.type.variable', value: 'uppercase', match: ['uppercase'] },
              { type: 'Twig.expression.type.string', value: 'ps-eyebrow--uppercase' },
              { type: 'Twig.expression.type.null', value: null },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '?',
              ...
              { type: 'Twig.expression.type.comma' },
              { type: 'Twig.expression.type.variable', value: 'bold', match: ['bold'] },
              { type: 'Twig.expression.type.string', value: 'ps-eyebrow--bold' },
              { type: 'Twig.expression.type.null', value: null },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '?',
              ...
              { type: 'Twig.expression.type.comma' },
              { type: 'Twig.expression.type.variable', value: 'withLine', match: ['withLine'] },
              { type: 'Twig.expression.type.string', value: 'ps-eyebrow--with-line' },
              { type: 'Twig.expression.type.null', value: null },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '?',
              ...
              { type: 'Twig.expression.type.comma' },
              { type: 'Twig.expression.type.variable', value: 'withDot', match: ['withDot'] },
              { type: 'Twig.expression.type.string', value: 'ps-eyebrow--with-dot' },
              { type: 'Twig.expression.type.null', value: null },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '?',
        ...
        },
        {
          ...
          value: `
<span `,
          position: { start: 1368, end: 1375 },
        },
        {
          type: 'output',
          position: { start: 1375, end: 1409 },
          stack: [
            {
  ...
  `,
        ...
        },
        {
          ...
          token: {
            ...
            position: { start: 1413, end: 1426 },
            output: [
              {
                type: 'raw',
                value: '    <span class="ps-eyebrow__icon" data-icon="',
                position: { start: 1427, end: 1473 },
              },
              {
                type: 'output',
                position: { start: 1473, end: 1483 },
                stack: [
                  {
                    type: 'Twig.expression.type.variable',
                    value: 'icon',
  ...
  `,
                position: { start: 1483, end: 1514 },
              },
            ],
          },
          position: { open: { start: 1413, end: 1426 }, close: { start: 1514, end: 1525 } },
        },
        {
          type: 'raw',
          value: '  <span class="ps-eyebrow__text">',
          position: { start: 1526, end: 1559 },
        },
        {
          type: 'output',
          position: { start: 1559, end: 1569 },
          stack: [
            {
              type: 'Twig.expression.type.variable',
              value: 'text',
  ...
  `,
        ...
        },
        {
          ...
          token: {
            ...
            position: { start: 1579, end: 1596 },
            output: [
              {
                type: 'raw',
                value: `    <span class="ps-eyebrow__line" aria-hidden="true"></span>
  `,
                position: { start: 1597, end: 1661 },
              },
            ],
          },
          position: { open: { start: 1579, end: 1596 }, close: { start: 1661, end: 1672 } },
        },
        { type: 'raw', value: '  ', position: { start: 1673, end: 1675 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.if',
            ...
            position: { start: 1675, end: 1691 },
            output: [
              {
                type: 'raw',
                value: `    <span class="ps-eyebrow__dot" aria-hidden="true">•</span>
  `,
                position: { start: 1692, end: 1756 },
              },
            ],
          },
          position: { open: { start: 1675, end: 1691 }, close: { start: 1756, end: 1767 } },
        },
        { type: 'raw', value: '</span>', position: { start: 1768, end: 1768 } },
      ],
      precompiled: !0,
    });
    ...
    try {
      ...
      return (
        Array.isArray(i) || (i = Object.entries(i)), y(n.render({ attributes: new W(i), ...t }))
      );
    } catch (i) {
      return y(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/elements/eyebrow/eyebrow.twig: ' +
          i.toString()
      );
    }
  },
...
a.parameters = {
  ...
  args: {
    ...data
      ...
      ...((c = (m = a.parameters) == null ? void 0 : m.docs) == null ? void 0 : c.source),
    },
  },
};
var u, v, g;
r.parameters = {
  ...
  \`
      ...
      ...((g = (v = r.parameters) == null ? void 0 : v.docs) == null ? void 0 : g.source),
    },
  },
};
var x, w, b;
o.parameters = {
  ...
  \`
      ...
      ...((b = (w = o.parameters) == null ? void 0 : w.docs) == null ? void 0 : b.source),
    },
  },
};
var h, T, f;
s.parameters = {
  ...
  \`
      ...
      ...((f = (T = s.parameters) == null ? void 0 : T.docs) == null ? void 0 : f.source),
    },
  },
};
var k, z, A;
p.parameters = {
  ...
  \`
      ...
      ...((A = (z = p.parameters) == null ? void 0 : z.docs) == null ? void 0 : A.source),
    },
  },
};
var $, D, L;
l.parameters = {
  ...
  \`
      ...
      ...((L = (D = l.parameters) == null ? void 0 : D.docs) == null ? void 0 : L.source),
    },
  },
};
const U = ['Default', 'AllVariants', 'AllSizes', 'AllStyles', 'WithDecorations', 'UseCases'];
export {
  o as AllSizes,
  s as AllStyles,
  r as AllVariants,
