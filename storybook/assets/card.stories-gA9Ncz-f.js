import{c as r}from"./card-yeJSuhnC.js";import"./iframe-DeCmpQ6I.js";import"./twig-Cbw8xbjJ.js";const V={variant:"default",layout:"vertical",size:"medium",radius:"none",imagePosition:"top"},B={title:"Components/Card",tags:["autodocs"],parameters:{docs:{description:{component:`Generic flexible container providing visual structure (border, padding, shadow) and layout variants. Content is composed freely via Twig blocks for maximum reusability.

Use composition to create specialized cards (OfferCard, NewsCard, etc.) that embed Card.`}}},argTypes:{variant:{control:{type:"select"},options:["default","outlined","flat","elevated"],description:"Visual variant",table:{category:"Appearance",type:{summary:"default | outlined | flat | elevated"},defaultValue:{summary:"default"}}},layout:{control:{type:"inline-radio"},options:["vertical","horizontal"],description:"Layout orientation",table:{category:"Appearance",type:{summary:"vertical | horizontal"},defaultValue:{summary:"vertical"}}},size:{control:{type:"inline-radio"},options:["small","medium","large"],description:"Padding size",table:{category:"Appearance",type:{summary:"small | medium | large"},defaultValue:{summary:"medium"}}},radius:{control:{type:"inline-radio"},options:["none","sm","md","lg"],description:"Border radius",table:{category:"Appearance",type:{summary:"none | sm | md | lg"},defaultValue:{summary:"none"}}},imagePosition:{control:{type:"select"},options:["top","bottom","left","right"],description:"Image position (top/bottom for vertical, left/right for horizontal)",table:{category:"Appearance",type:{summary:"top | bottom | left | right"},defaultValue:{summary:"top"}}},url:{control:"text",description:"Optional URL (renders card as clickable <a> element)",table:{category:"Link",type:{summary:"string"}}}}},t={render:a=>r({...a,image:'<img src="https://loremflickr.com/640/480/office,building" alt="Modern office building" style="display: block; width: 100%; height: 100%; object-fit: cover;" />',header:'<h3 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: var(--gray-900);">Modern Office Space</h3>',body:'<p style="margin: 0; font-size: 1rem; color: var(--gray-600);">Premium office building located in the heart of Madrid business district. Features modern amenities, underground parking, and excellent public transport connections.</p>',footer:`<div style="display: flex; gap: 1rem; align-items: center;">
    ...
    `},o={render:()=>`
      <div style="display: grid; gap: var(--size-8);">
        <div>
          ...
          ${r({layout:"vertical",radius:"md",image:'<img src="https://loremflickr.com/640/480/house,property?random=1" alt="Property" style="display: block; width: 100%; height: 240px; object-fit: cover;" />',header:'<h3 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: var(--gray-900);">Luxury Apartment Paris</h3>',body:'<p style="margin: 0; font-size: 1rem; color: var(--gray-600);">Spacious 3-bedroom apartment in the 8th arrondissement. High ceilings, Haussmann architecture, recent renovation.</p>',footer:`<div style="display: flex; gap: 1rem;">
        ...
        <div>
          ...
          ${r({layout:"horizontal",radius:"md",image:'<img src="https://loremflickr.com/640/480/villa,property?random=2" alt="Property" style="display: block; width: 100%; height: 100%; object-fit: cover;" />',header:`<h3 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: var(--gray-900);">Villa Côte d'Azur</h3>`,body:'<p style="margin: 0; font-size: 1rem; color: var(--gray-600);">Exceptional waterfront villa with panoramic Mediterranean sea views. Private pool, 5 bedrooms, landscaped garden.</p>',footer:`<div style="display: flex; gap: 1rem;">
        ...
        <div>
          ...
          ${r({layout:"horizontal",imagePosition:"right",radius:"md",image:'<img src="https://loremflickr.com/640/480/commercial,real-estate?random=3" alt="Property" style="display: block; width: 100%; height: 100%; object-fit: cover;" />',header:'<h3 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: var(--gray-900);">Commercial Space Barcelona</h3>',body:'<p style="margin: 0; font-size: 1rem; color: var(--gray-600);">Prime retail location on Las Ramblas. High foot traffic, flexible layout, excellent visibility.</p>',footer:`<div style="display: flex; gap: 1rem;">
    ...
    `},d={render:()=>`
      <div style="display: grid; gap: var(--size-8);">
        <div>
          ...
          ${r({url:"#property-789",variant:"elevated",radius:"lg",image:'<img src="https://loremflickr.com/640/480/real-estate,listing?random=use1" alt="Property listing" style="display: block; width: 100%; height: 240px; object-fit: cover;" />',header:`<div style="display: flex; justify-content: space-between; align-items: start;">
            ...
            </div>`,body:`<p style="margin: 0 0 var(--size-3) 0; font-size: 1rem; color: var(--gray-600);">Exceptional duplex penthouse with 360° views of Paris. Terraces, private elevator, luxury finishes.</p>
            ...
            </div>`,footer:`<div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div>
          ...
          ${r({url:"#article-123",layout:"horizontal",radius:"md",image:'<img src="https://loremflickr.com/640/480/meeting,business?random=use2" alt="Article" style="display: block; width: 100%; height: 100%; object-fit: cover;" />',header:`<div>
            ...
            </div>`,body:'<p style="margin: 0; font-size: 0.875rem; color: var(--gray-600); line-height: 1.5;">Analysis of key trends shaping the commercial real estate sector across major European markets...</p>',footer:`<div style="display: flex; gap: var(--size-2); align-items: center; font-size: 0.75rem; color: var(--gray-500);">
        ...
        <div>
          ...
          ${r({variant:"outlined",radius:"md",size:"small",header:'<h3 style="margin: 0; font-size: 1rem; font-weight: 600; color: var(--gray-900);">Contact Information</h3>',body:`<div style="display: flex; flex-direction: column; gap: 0.5rem; font-size: 0.875rem; color: var(--gray-600);">
    ...
    `};var m,p,c;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => {
    return cardTwig({
      ...args,
...
}`,...(c=(p=t.parameters)==null?void 0:p.docs)==null?void 0:c.source}}};var g,y,f;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
...
}`,...(f=(y=i.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var h,v,u;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => {
    return \`
      <div style="display: grid; gap: var(--size-8);">
        <div>
...
}`,...(u=(v=o.parameters)==null?void 0:v.docs)==null?void 0:u.source}}};var z,b,w;n.parameters={...n.parameters,docs:{...(z=n.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => {
...
}`,...(w=(b=n.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var x,k,P;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {
...
}`,...(P=(k=s.parameters)==null?void 0:k.docs)==null?void 0:P.source}}};var $,C,j;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {
    return \`
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: var(--size-6);">
        \${cardTwig({
...
}`,...(j=(C=l.parameters)==null?void 0:C.docs)==null?void 0:j.source}}};var A,S,T;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => {
    return \`
      <div style="display: grid; gap: var(--size-8);">
        <div>
...
}`,...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};const I=["Default","AllVariants","AllLayouts","AllSizes","AllRadius","ClickableCards","UseCases"];export{o as AllLayouts,s as AllRadius,n as AllSizes,i as AllVariants,l as ClickableCards,t as Default,d as UseCases,I as __namedExportsOrder,B as default};
