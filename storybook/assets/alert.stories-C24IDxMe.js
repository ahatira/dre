...
`,position:{start:2783,end:2783}}],precompiled:!0});r.options.allowInlineIncludes=!0;try{let a=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(a)||(a=Object.entries(a)),w(r.render({attributes:new Q(a),...t}))}catch(a){return w("An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/components/alert/alert.twig: "+a.toString())}},G={variant:"info",title:"Information",message:"This is an informational alert message.",icon:!0,dismissible:!1,compact:!1};((t,r)=>{function a(s){s.classList.add("is-closing"),s.addEventListener("animationend",()=>{s.remove()},{once:!0})}t.behaviors.psAlert={attach(s){r("ps-alert-close",".ps-alert__close",s).forEach(i=>{i.addEventListener("click",()=>{const n=i.closest(".ps-alert");n&&a(n)})}),window.PSAlert={dismiss:i=>{i!=null&&i.classList.contains("ps-alert")&&a(i)},dismissAll:()=>{document.querySelectorAll(".ps-alert").forEach(n=>a(n))}}}}})(Drupal,once);const ae={title:"Components/Alert",tags:["autodocs"],render:t=>e(t),args:G,parameters:{docs:{description:{component:"Semantic alert component for status messages with accessible roles and tokenized design."}}},argTypes:{variant:{description:"Semantic variant of the alert",control:{type:"select"},options:["info","success","warning","error","info-subtle","success-subtle","warning-subtle","error-subtle","default","primary","secondary","light","dark"],table:{category:"Appearance",type:{summary:"info | success | warning | error | info-subtle | success-subtle | warning-subtle | error-subtle | default | primary | secondary | light | dark"},defaultValue:{summary:"info"}}},title:{description:"Optional title text",control:{type:"text"},table:{category:"Content",type:{summary:"string"},defaultValue:{summary:'""'}}},message:{description:"Message content (supports HTML)",control:{type:"text"},table:{category:"Content",type:{summary:"string"},defaultValue:{summary:'""'}}},icon:{description:"Show icon (icons: info=infos, success=check, warning=help, error=close)",control:{type:"boolean"},table:{category:"Appearance",type:{summary:"boolean"},defaultValue:{summary:"true"}}},dismissible:{description:"Show close button with JavaScript dismiss behavior",control:{type:"boolean"},table:{category:"Behavior",type:{summary:"boolean"},defaultValue:{summary:"false"}}},compact:{description:"Reduced padding for dense layouts",control:{type:"boolean"},table:{category:"Appearance",type:{summary:"boolean"},defaultValue:{summary:"false"}}}}},o={render:t=>e(t),args:{...G}},p={render:()=>`
  ...
  `};var T,f,x;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => alertTwig(args),
  args: {
    ...data
  }
}`,...(x=(f=o.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};var h,b,k;p.parameters={...p.parameters,docs:{...(h=p.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'info',
  ...
  \`
}`,...(k=(b=p.parameters)==null?void 0:b.docs)==null?void 0:k.source}}};var $,S,z;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'info-subtle',
  ...
  \`
}`,...(z=(S=l.parameters)==null?void 0:S.docs)==null?void 0:z.source}}};var L,A,P;c.parameters={...c.parameters,docs:{...(L=c.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'info',
  ...
  \`
}`,...(P=(A=c.parameters)==null?void 0:A.docs)==null?void 0:P.source}}};var C,E,D;y.parameters={...y.parameters,docs:{...(C=y.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'info',
  ...
  \`
}`,...(D=(E=y.parameters)==null?void 0:E.docs)==null?void 0:D.source}}};var R,_,W;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'primary',
  ...
  \`
}`,...(W=(_=g.parameters)==null?void 0:_.docs)==null?void 0:W.source}}};var B,I,V;u.parameters={...u.parameters,docs:{...(B=u.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'info',
  ...
  \`
}`,...(V=(I=u.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var Y,N,U;d.parameters={...d.parameters,docs:{...(Y=d.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-3); max-width: 320px;">
      \${alertTwig({
    variant: 'info',
  ...
  \`
}`,...(U=(N=d.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};var M,O,j;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-4);">
      \${alertTwig({
    variant: 'info',
  ...
  \`
}`,...(j=(O=m.parameters)==null?void 0:O.docs)==null?void 0:j.source}}};var H,F,q;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; flex-direction: column; gap: var(--size-6);">
      <div>
        <h3 style="margin: 0 0 var(--size-4) 0; font-size: var(--size-4);">Form Submission Success</h3>
  ...
  \`
}`,...(q=(F=v.parameters)==null?void 0:F.docs)==null?void 0:q.source}}};const ie=["Default","AllVariants","SubtleVariants","WithoutTitle","WithoutIcon","BrandColors","Dismissible","Compact","WithHTML","UseCases"];export{p as AllVariants,g as BrandColors,d as Compact,o as Default,u as Dismissible,l as SubtleVariants,v as UseCases,m as WithHTML,y as WithoutIcon,c as WithoutTitle,ie as __namedExportsOrder,ae as default};
