import{t,T as i}from"./iframe-dKZZTA21.js";import{D as a,a as o}from"./twig-P2Jeg5-K.js";import"https://kit.fontawesome.com/a0eb0bad75.js";o(i);i.cache(!1);const s=r=>r,n=(r={})=>{const d=t.twig({id:"C:/wamp64/www/ps_theme/source/patterns/base/borders/borders.twig",data:[{type:"raw",value:`<section class="demo-borders">\r
...
`,position:{start:0,end:0}}],precompiled:!0});d.options.allowInlineIncludes=!0;try{let e=r.defaultAttributes?r.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),s(d.render({attributes:new a(e),...r}))}catch(e){return s("An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/base/borders/borders.twig: "+e.toString())}},b={title:"Base/Borders"},c={name:"Borders",render:r=>n(r)},w=["Borders"];export{c as Borders,w as __namedExportsOrder,b as default};
