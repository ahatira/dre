import { f as p } from './flag-CNh5c8TV.js';
...
const M = [
  ...
  B = { code: 'FR', label: 'France', size: 'md', shape: 'square', disabled: !1, decorative: !1 },
  b = {
    title: 'Elements/Flag',
    tags: ['autodocs'],
    parameters: {
  ...
  n = { render: (a) => p(a), args: { ...B } },
  i = {
    render: () => {
      const a = 'margin-bottom:var(--size-8)',
        s =
        ...
        o = 'display:flex;flex-direction:column;align-items:center;gap:var(--size-2)',
        c = 'font-size:var(--size-3);color:var(--gray-700)';
  ...
  r = {
    ...
    render: () => {
      const a = 'display:flex;flex-direction:column;gap:var(--size-6)',
        s = 'display:flex;gap:var(--size-3);align-items:center;flex-wrap:wrap',
        l =
          'display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr));gap:var(--size-4)',
        o = 'display:flex;flex-direction:column;align-items:center;gap:var(--size-2)',
        c = 'font-size:var(--size-3);color:var(--gray-700)',
    ...
    `
            ...
            .join(''),
        d = M.filter((e) => e.length === 2 || e.includes('-'));
      return `
      <div style="${a}">
...
n.parameters = {
  ...
  args: {
    ...data
      ...
      ...((S = (y = n.parameters) == null ? void 0 : y.docs) == null ? void 0 : S.source),
    },
  },
};
var A, v, C;
i.parameters = {
  ...
  render: () => {
    ...
    return \`<div>\${sections}</div>\`;
      ...
      ...((C = (v = i.parameters) == null ? void 0 : v.docs) == null ? void 0 : C.source),
    },
  },
};
var f, E, G;
r.parameters = {
  ...
  render: () => {
    ...
    \`;
      ...
      ...((G = (E = r.parameters) == null ? void 0 : E.docs) == null ? void 0 : G.source),
    },
  },
};
const x = ['Default', 'AllCountries', 'AllCountriesFull'];
export {
  i as AllCountries,
  r as AllCountriesFull,
  n as Default,
