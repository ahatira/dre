import{t as d,T as r}from"./iframe-B-yX16js.js";import{D as n,a as t}from"./twig-CgICq6Dc.js";t(r);r.cache(!1);const e=s=>s,w=(s={})=>{const a=d.twig({id:"C:/wamp64/www/ps_theme/source/patterns/base/shadows/shadows.twig",data:[{type:"raw",value:`<section class="demo-shadows">\r
...
`,position:{start:0,end:0}}],precompiled:!0});a.options.allowInlineIncludes=!0;try{let o=s.defaultAttributes?s.defaultAttributes:[];return Array.isArray(o)||(o=Object.entries(o)),e(a.render({attributes:new n(o),...s}))}catch(o){return e("An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/base/shadows/shadows.twig: "+o.toString())}},l={title:"Base/Shadows",parameters:{docs:{description:{component:`
...
- **Usage**: Elevation, focus states, depth
        `}}}},v={name:"Shadows",render:s=>w(s)},c=["Shadows"];export{v as Shadows,c as __namedExportsOrder,l as default};
