import { c as e } from './collapse-BqPlnqGy.js';
...
const v = {
    ...
    content:
      'This modern apartment features hardwood floors, stainless steel appliances, and floor-to-ceiling windows with stunning city views. Located in a prime downtown location with easy access to public transportation.',
    expanded: !1,
  },
  T = {
  ...
  a = { args: v, render: (n) => e(n) },
  t = { args: { ...v, expanded: !0 }, render: (n) => e(n) },
  i = {
    args: {
      id: 'collapse-basic',
...
a.parameters = {
  ...
  render: args => collapseTwig(args)
      ...
      ...((l = (s = a.parameters) == null ? void 0 : s.docs) == null ? void 0 : l.source),
    },
  },
};
var c, d, p;
...
r.parameters = {
  ...
  \`
      ...
      ...((h = (y = r.parameters) == null ? void 0 : y.docs) == null ? void 0 : h.source),
    },
  },
};
const k = ['Default', 'Expanded', 'BasicContent', 'Variants'];
export {
  i as BasicContent,
  a as Default,
  t as Expanded,
