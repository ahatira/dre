import { T as d, t as n } from './iframe-D21U4yYN.js';
import { a as i, D as o } from './twig-BPJOkNgt.js';
i(d);
d.cache(!1);
const a = (r) => r,
  t = (r = {}) => {
    const e = n.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/base/borders/borders.twig',
      data: [
        {
          type: 'raw',
          value: `<section class="demo-borders">\r
...
`,
    ...
    e.options.allowInlineIncludes = !0;
    try {
      let s = r.defaultAttributes ? r.defaultAttributes : [];
      return (
        Array.isArray(s) || (s = Object.entries(s)), a(e.render({ attributes: new o(s), ...r }))
      );
    } catch (s) {
      return a(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/base/borders/borders.twig: ' +
          s.toString()
      );
    }
  },
...
- **Total**: 19 border tokens
  ...
  u = { name: 'Borders', render: (r) => t(r) },
  p = ['Borders'];
export { u as Borders, p as __namedExportsOrder, v as default };
