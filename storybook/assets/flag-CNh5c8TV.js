import { t as a, T as s } from './iframe-D21U4yYN.js';
...
const p = (t) => t,
  l = (t = {}) => {
    const i = a.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/elements/flag/flag.twig',
      data: [
  ...
  <img class="ps-flag__img" src="`,
    ...
    try {
      ...
      return (
        Array.isArray(e) || (e = Object.entries(e)), p(i.render({ attributes: new r(e), ...t }))
      );
    } catch (e) {
      return p(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/elements/flag/flag.twig: ' +
          e.toString()
      );
    }
  };
