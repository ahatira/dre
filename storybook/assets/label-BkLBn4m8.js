import { T as i, t as p } from './iframe-D21U4yYN.js';
...
const a = (t) => t,
  y = (t = {}) => {
    const s = p.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/elements/label/label.twig',
      data: [
  ...
  `,
    ...
    try {
      ...
      return (
        Array.isArray(e) || (e = Object.entries(e)), a(s.render({ attributes: new r(e), ...t }))
      );
    } catch (e) {
      return a(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/elements/label/label.twig: ' +
          e.toString()
      );
    }
  };
