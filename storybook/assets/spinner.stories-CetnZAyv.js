import { T as _, t as P } from './iframe-D21U4yYN.js';
import { D as C, a as X } from './twig-BPJOkNgt.js';
X(_);
_.cache(!1);
const d = (r) => r,
  e = (r = {}) => {
    const l = P.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/elements/spinner/spinner.twig',
      data: [
        { type: 'raw', value: '', position: { start: 719, end: 723 } },
        {
          type: 'logic',
          token: {
            ...
            expression: [
              { type: 'Twig.expression.type.variable', value: 'variant', match: ['variant'] },
              {
                ...
                params: [
                  ...
                  { type: 'Twig.expression.type.string', value: 'circular' },
                  {
            ...
            position: { start: 723, end: 772 },
          },
          position: { start: 723, end: 772 },
        },
        { type: 'raw', value: '', position: { start: 772, end: 774 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            ...
            position: { start: 774, end: 811 },
          },
          position: { start: 774, end: 811 },
        },
        { type: 'raw', value: '', position: { start: 811, end: 813 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            ...
            position: { start: 813, end: 857 },
          },
          position: { start: 813, end: 857 },
        },
        { type: 'raw', value: '', position: { start: 857, end: 859 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            ...
            position: { start: 859, end: 904 },
          },
          position: { start: 859, end: 904 },
        },
        { type: 'raw', value: '', position: { start: 904, end: 906 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            key: 'centered',
            expression: [
              { type: 'Twig.expression.type.variable', value: 'centered', match: ['centered'] },
              {
                type: 'Twig.expression.type.filter',
                value: 'default',
                match: ['|default', 'default'],
            ...
            position: { start: 906, end: 952 },
          },
          position: { start: 906, end: 952 },
        },
        { type: 'raw', value: '', position: { start: 952, end: 954 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            ...
            position: { start: 954, end: 1017 },
          },
          position: { start: 954, end: 1017 },
        },
        { type: 'raw', value: '', position: { start: 1017, end: 1021 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            ...
            expression: [
              ...
              { type: 'Twig.expression.type.string', value: 'ps-spinner' },
              ...
              { type: 'Twig.expression.type.comma' },
              { type: 'Twig.expression.type.variable', value: 'centered', match: ['centered'] },
              { type: 'Twig.expression.type.string', value: 'ps-spinner--centered' },
              { type: 'Twig.expression.type.null', value: null },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '?',
            ...
            position: { start: 1021, end: 1271 },
          },
          position: { start: 1021, end: 1271 },
        },
        { type: 'raw', value: '<div ', position: { start: 1271, end: 1280 } },
        {
          type: 'output',
          position: { start: 1280, end: 1314 },
          stack: [
            {
        ...
        },
        {
          ...
          token: {
            ...
            position: { start: 1352, end: 1384 },
            output: [
              {
                type: 'raw',
                value: `<svg class="ps-spinner__svg" viewBox="0 0 50 50">\r
      <circle class="ps-spinner__circle" cx="25" cy="25" r="20" fill="none" stroke-width="4"></circle>\r
    </svg>`,
                position: { start: 1384, end: 1559 },
              },
            ],
          },
          position: { open: { start: 1352, end: 1384 }, close: { start: 1559, end: 1591 } },
        },
        {
          type: 'logic',
          token: {
            ...
            stack: [
              { type: 'Twig.expression.type.variable', value: 'variant', match: ['variant'] },
              { type: 'Twig.expression.type.string', value: 'dots' },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '==',
                precidence: 9,
            ...
            position: { start: 1559, end: 1591 },
            output: [
              {
                type: 'raw',
                value: `<span class="ps-spinner__dot"></span>\r
    <span class="ps-spinner__dot"></span>\r
    <span class="ps-spinner__dot"></span>`,
                position: { start: 1591, end: 1724 },
              },
            ],
          },
          position: { open: { start: 1559, end: 1591 }, close: { start: 1724, end: 1756 } },
        },
        {
          type: 'logic',
          token: {
            ...
            stack: [
              { type: 'Twig.expression.type.variable', value: 'variant', match: ['variant'] },
              { type: 'Twig.expression.type.string', value: 'bars' },
              {
                type: 'Twig.expression.type.operator.binary',
                value: '==',
                precidence: 9,
            ...
            position: { start: 1724, end: 1756 },
            output: [
              {
                type: 'raw',
                value: `<span class="ps-spinner__bar"></span>\r
    <span class="ps-spinner__bar"></span>\r
    <span class="ps-spinner__bar"></span>`,
                position: { start: 1756, end: 1889 },
              },
            ],
          },
          position: { open: { start: 1724, end: 1756 }, close: { start: 1889, end: 1902 } },
        },
        {
          type: 'raw',
          value: '<span class="ps-spinner__text">',
          position: { start: 1902, end: 1937 },
        },
        {
          type: 'output',
          position: { start: 1937, end: 1947 },
          stack: [
            {
              type: 'Twig.expression.type.variable',
              value: 'text',
...
`,
          position: { start: 1947, end: 1947 },
        },
      ],
      precompiled: !0,
    });
    l.options.allowInlineIncludes = !0;
    try {
      let t = r.defaultAttributes ? r.defaultAttributes : [];
      return (
        Array.isArray(t) || (t = Object.entries(t)), d(l.render({ attributes: new C(t), ...r }))
      );
    } catch (t) {
      return d(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/elements/spinner/spinner.twig: ' +
          t.toString()
      );
    }
  },
  A = { variant: 'circular', size: 'md', color: 'default', text: 'Loading...', centered: !1 },
  B = {
...
Supports variants, sizes, semantic colors, centering, and screen-reader text.`,
    ...
    argTypes: {
      ...
      size: {
        description: 'Spinner size (xs: 16px, sm: 24px, md: 32px, lg: 48px, xl: 64px, xxl: 80px)',
        control: { type: 'select' },
  ...
  `,
    parameters: {
      docs: {
        description: {
          story:
            '6 sizes available: XS (16px) for buttons, SM (24px) for inline, MD (32px) default, LG (48px) for centered areas, XL (64px) for full page loading, XXL (80px) for hero sections.',
        },
      },
    },
  },
...
i.parameters = {
  ...
  args: {
    ...data
      ...
      ...((y = (c = i.parameters) == null ? void 0 : c.docs) == null ? void 0 : y.source),
    },
  },
};
var v, m, u;
a.parameters = {
  ...
  parameters: {
    docs: {
      ...
      ...((u = (m = a.parameters) == null ? void 0 : m.docs) == null ? void 0 : u.source),
    },
  },
};
var x, f, b;
s.parameters = {
  ...
  parameters: {
    docs: {
      ...
      ...((b = (f = s.parameters) == null ? void 0 : f.docs) == null ? void 0 : b.source),
    },
  },
};
var w, h, z;
n.parameters = {
  ...
  parameters: {
    docs: {
      ...
      ...((z = (h = n.parameters) == null ? void 0 : h.docs) == null ? void 0 : z.source),
    },
  },
};
var T, k, $;
o.parameters = {
  ...
  parameters: {
    docs: {
      ...
      ...(($ = (k = o.parameters) == null ? void 0 : k.docs) == null ? void 0 : $.source),
    },
  },
};
var S, L, D;
p.parameters = {
  ...
  parameters: {
    docs: {
      ...
      ...((D = (L = p.parameters) == null ? void 0 : L.docs) == null ? void 0 : D.source),
    },
  },
};
const I = ['Default', 'AllVariants', 'AllSizes', 'AllColors', 'Centered', 'UseCases'];
export {
  n as AllColors,
  s as AllSizes,
  a as AllVariants,
