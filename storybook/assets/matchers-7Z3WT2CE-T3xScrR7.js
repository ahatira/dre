...
var xe = Object.defineProperties(() => {}, {
  ...
  Ge = (e, r) => {
    ...
    if (r.includes('\x1B')) for (; n !== void 0; ) (r = Fe(r, n.close, n.open)), (n = n.parent);
    const _ = r.indexOf(`
`);
  ...
  ut = F({
    'node_modules/pretty-format/build/plugins/ReactElement.js'(e) {
      ...
      function c(l, a) {
        ...
        for (var O in l)
          if (O !== 'default' && Object.hasOwn(l, O)) {
      ...
      function Q(t) {
        if (
          (Object.keys(t).forEach((b) => {
            if (!Object.hasOwn(k, b)) throw new Error(`pretty-format: Unknown option "${b}".`);
          }),
