import { T as n, t as p } from './iframe-D21U4yYN.js';
import { D as d, a as l } from './twig-BPJOkNgt.js';
l(n);
n.cache(!1);
const s = (e) => e,
  m = (e = {}) => {
    const r = p.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/base/aspects/aspects.twig',
      data: [
        {
          type: 'raw',
          value: `<section class="demo-aspect-ratio">\r
...
`,
    ...
    try {
      ...
      return (
        Array.isArray(t) || (t = Object.entries(t)), s(r.render({ attributes: new d(t), ...e }))
      );
    } catch (t) {
      return s(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/base/aspects/aspects.twig: ' +
          t.toString()
      );
    }
  },
...
- **Browser support**: Modern browsers (IE11 fallback needed)
  ...
  a = { name: 'Aspect ratios', render: (e) => m(e) };
var o, i, c;
a.parameters = {
  ...a.parameters,
  docs: {
  ...
  render: args => aspects(args)
      ...
      ...((c = (i = a.parameters) == null ? void 0 : i.docs) == null ? void 0 : c.source),
    },
  },
};
const g = ['Aspects'];
export { a as Aspects, g as __namedExportsOrder, w as default };
