import { T as f, t as h } from './iframe-D21U4yYN.js';
import { D as w, a as x } from './twig-BPJOkNgt.js';
x(f);
f.cache(!1);
const l = (t) => t,
  e = (t = {}) => {
    const o = h.twig({
      id: 'C:/wamp64/www/ps_theme/source/patterns/elements/radio/radio.twig',
      data: [
        { type: 'raw', value: '', position: { start: 512, end: 513 } },
        {
          type: 'logic',
          token: {
            ...
            expression: [
              { type: 'Twig.expression.type.variable', value: 'name', match: ['name'] },
              {
                ...
                params: [
                  ...
                  { type: 'Twig.expression.type.string', value: 'radio' },
                  {
          ...
          token: {
            ...
            expression: [
              { type: 'Twig.expression.type.variable', value: 'value', match: ['value'] },
              {
                ...
                params: [
                  { type: 'Twig.expression.type.parameter.start', value: '(', match: ['('] },
                  { type: 'Twig.expression.type.string', value: '1' },
                  {
                    type: 'Twig.expression.type.parameter.end',
                    value: ')',
                    match: [')'],
          ...
          token: {
            ...
            expression: [
              { type: 'Twig.expression.type.variable', value: 'label', match: ['label'] },
              {
                ...
                params: [
                  { type: 'Twig.expression.type.parameter.start', value: '(', match: ['('] },
                  { type: 'Twig.expression.type.string', value: 'Option label' },
                  {
                    type: 'Twig.expression.type.parameter.end',
                    value: ')',
                    match: [')'],
        ...
        },
        {
          ...
          token: {
            ...
            position: { start: 735, end: 798 },
          },
          position: { start: 735, end: 798 },
        },
        { type: 'raw', value: '', position: { start: 799, end: 800 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.set',
            ...
            expression: [
              ...
              { type: 'Twig.expression.type.string', value: 'ps-radio' },
              { type: 'Twig.expression.type.comma' },
              { type: 'Twig.expression.type.variable', value: 'disabled', match: ['disabled'] },
              { type: 'Twig.expression.type.string', value: 'ps-radio--disabled' },
            ...
            position: { start: 800, end: 880 },
          },
          position: { start: 800, end: 880 },
        },
        { type: 'raw', value: '<label ', position: { start: 881, end: 889 } },
        {
          type: 'output',
          position: { start: 889, end: 923 },
          stack: [
            {
  ...
  <input
    ...
    name="`,
          position: { start: 923, end: 989 },
        },
        {
          type: 'output',
          position: { start: 989, end: 999 },
          stack: [
            {
              type: 'Twig.expression.type.variable',
              value: 'name',
        ...
        },
        {
          ...
          value: `"
    value="`,
          position: { start: 999, end: 1012 },
        },
        {
          type: 'output',
          position: { start: 1012, end: 1023 },
          stack: [
            {
              type: 'Twig.expression.type.variable',
              value: 'value',
    ...
    `,
        ...
        },
        {
          ...
          token: {
            ...
            position: { start: 1029, end: 1045 },
            output: [{ type: 'raw', value: 'checked', position: { start: 1045, end: 1052 } }],
          },
          position: { open: { start: 1029, end: 1045 }, close: { start: 1052, end: 1063 } },
        },
        { type: 'raw', value: '    ', position: { start: 1064, end: 1068 } },
        {
          type: 'logic',
          token: {
            type: 'Twig.logic.type.if',
            ...
            position: { start: 1068, end: 1085 },
            output: [{ type: 'raw', value: 'disabled', position: { start: 1085, end: 1093 } }],
          },
          position: { open: { start: 1068, end: 1085 }, close: { start: 1093, end: 1104 } },
        },
        { type: 'raw', value: '    aria-checked="', position: { start: 1105, end: 1123 } },
        {
          type: 'output',
          position: { start: 1123, end: 1155 },
          stack: [
            {
              type: 'Twig.expression.type.variable',
              value: 'checked',
  ...
  `,
        ...
        },
        {
          ...
          token: {
            ...
            position: { start: 1224, end: 1238 },
            output: [
              {
                type: 'raw',
                value: '    <span class="ps-radio__label">',
                position: { start: 1239, end: 1273 },
              },
              {
                type: 'output',
                position: { start: 1273, end: 1284 },
                stack: [
                  {
                    type: 'Twig.expression.type.variable',
                    value: 'label',
              ...
              },
              {
                ...
                value: `</span>
  `,
                position: { start: 1284, end: 1294 },
              },
            ],
          },
          position: { open: { start: 1224, end: 1238 }, close: { start: 1294, end: 1305 } },
        },
        { type: 'raw', value: '</label>', position: { start: 1306, end: 1306 } },
      ],
      precompiled: !0,
    });
    ...
    try {
      ...
      return (
        Array.isArray(a) || (a = Object.entries(a)), l(o.render({ attributes: new w(a), ...t }))
      );
    } catch (a) {
      return l(
        'An error occurred whilst rendering C:/wamp64/www/ps_theme/source/patterns/elements/radio/radio.twig: ' +
          a.toString()
      );
    }
  },
  b = { name: 'option', value: '1', label: 'Option label', checked: !1, disabled: !1 },
  z = {
...
i.parameters = {
  ...
  args: {
    ...data
      ...
      ...((d = (n = i.parameters) == null ? void 0 : n.docs) == null ? void 0 : d.source),
    },
  },
};
var c, y, u;
s.parameters = {
  ...
  \`
      ...
      ...((u = (y = s.parameters) == null ? void 0 : y.docs) == null ? void 0 : u.source),
    },
  },
};
var v, m, g;
r.parameters = {
  ...
  \`
      ...
      ...((g = (m = r.parameters) == null ? void 0 : m.docs) == null ? void 0 : g.source),
    },
  },
};
const $ = ['Default', 'AllStates', 'UseCases'];
export { s as AllStates, i as Default, r as UseCases, $ as __namedExportsOrder, z as default };
