...
class Attributes extends ArrayObject {
   ...
   *
   * @see \Drupal\ui_suite_bnppre\Utility\ArrayObject::offsetGet()
   */
   ...
   *   TRUE or FALSE.
   *
   * @see \Drupal\ui_suite_bnppre\Utility\ArrayObject::offsetExists()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnppre\Utility\ArrayObject::offsetUnset()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnppre\Utility\ArrayObject::offsetSet()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnppre\Utility\ArrayObject::merge()
   */
