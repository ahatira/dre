...
class DrupalAttributes extends ArrayObject {
   ...
   *
   * @var \Drupal\ui_suite_bnppre\Utility\Attributes[]
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::addClass()
   */
   ...
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::getAttribute()
   */
   ...
   *   (optional) The type of attributes to use for this method.
   *
   * @return \Drupal\ui_suite_bnppre\Utility\Attributes
   ...
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::getClasses()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::hasAttribute()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::hasClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::removeAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::removeClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::replaceClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::setAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\ui_suite_bnppre\Utility\Attributes::setAttributes()
   */
