...
class Element extends DrupalAttributes
{
   ...
   *
   * @return \Drupal\ui_suite_bnppre\Utility\Element
   *   The child element object.
   */
    public function &__get($key)
    {
        if (CoreElement::property($key)) {
            throw new \InvalidArgumentException('Cannot dynamically retrieve element property. Use \Drupal\ui_suite_bnppre\Utility\Element::getProperty instead.');
        }
   ...
   */
    ...
    {
        if (CoreElement::property($key)) {
            throw new \InvalidArgumentException('Cannot dynamically retrieve element property. Use  \Drupal\ui_suite_bnppre\Utility\Element::setProperty instead.');
        }
   ...
   */
    public function __isset($name)
    {
        if (CoreElement::property($name)) {
            throw new \InvalidArgumentException('Cannot dynamically check if an element has a property. Use  \Drupal\ui_suite_bnppre\Utility\Element::unsetProperty instead.');
        }
   ...
   */
    ...
    {
        if (CoreElement::property($name)) {
            throw new \InvalidArgumentException('Cannot dynamically unset an element property. Use  \Drupal\ui_suite_bnppre\Utility\Element::hasProperty instead.');
        }
        parent::__unset($name);
    }
  ...
  /**
   * Creates a new \Drupal\ui_suite_bnppre\Utility\Element instance.
   *
   * @param array|string|\Drupal\ui_suite_bnppre\Utility\Element $element
   ...
   *
   * @return \Drupal\ui_suite_bnppre\Utility\Element|false
   ...
   */
    ...
    {
        return $this->getRenderer()->render($this->array);
    }
   ...
   */
    public function renderPlain()
    {
        return DeprecationHelper::backwardsCompatibleCall(
            ...
            currentCallable: fn () => $this->getRenderer()->renderInIsolation($this->array),
            // @phpstan-ignore-next-line
            deprecatedCallable: fn () => $this->getRenderer()->renderPlain($this->array),
        );
    }
   ...
   */
    ...
    {
        return $this->getRenderer()->renderRoot($this->array);
    }
