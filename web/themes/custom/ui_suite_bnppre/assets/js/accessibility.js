((Drupal, once) => {
  Drupal.ui_suite_bnppre_accessibility =
    Drupal.ui_suite_bnppre_accessibility || {};

  Drupal.ui_suite_bnppre_accessibility.pointer_elements = ['a', 'input'];

  function preventClick(element) {
    if (
      Drupal.ui_suite_bnppre_accessibility.pointer_elements.includes(
  ...
  Drupal.behaviors.ui_suite_bnppre_accessibility = {
    attach(context) {
