...
/**
 * Plugin implementation of the oEmbed formatter for PS Media.
 *
 * @internal
 *   This is an internal part of the oEmbed system and should only be used by
 *   oEmbed-related code in PS Media.
 *
 * @FieldFormatter(
 *   id = "ps_oembed",
 *   label = @Translation("PS oEmbed content"),
 *   field_types = {
 *     "link",
 *     "string",
 *     "string_long",
 ...
 * )
 */
class PsOEmbedFormatter extends OEmbedFormatter {
